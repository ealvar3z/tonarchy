...
- Attribution and licensing notice: =NOTICE.md=
- Release/source-distribution checklist: =RELEASING.md=

* Repository Notes

- Package group manifests live in =profiles/packages/=.
- Wallpaper assets live in =assets/wallpapers/=.
...
This project is licensed under =GNU GPL v2 only=.

- Full text: =LICENSE=
- Fork attribution and modification notice: =NOTICE.md=

If you distribute ISO images or binaries, you must provide the corresponding
source code for that exact build, as required by GPLv2. See =RELEASING.md=
for the release checklist used by this fork.
